...
export const SITE_URL = 'https://kautilya.pro';
export const SITE_TITLE = 'Kautilya Bhardwaj';
export const SITE_DESCRIPTION = "A polymath's canvas — systems architecture, curiosity, and the art of figuring things out.";
export const AUTHOR_NAME = 'Kautilya Bhardwaj';
export const AUTHOR_GITHUB = 'https://github.com/kautilya-pro';
export const AUTHOR_LINKEDIN = 'https://linkedin.com/in/kautilya-pro';
